...
sqlString=new String("update student set "+ "name='"+name+"', address='"+address+"', city_code="+cityCode+", gender='"+gender+"', indian="+indian+", date_of_birth='"+dob+"' where roll_number="+rollNumber+"");
int i=-1;

i=s.executeUpdate(sqlString);

MessageBean mb=new MessageBean();
mb.setMessage("Successfully edited");
